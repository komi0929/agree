...
const ANALYSIS_STEPS: AnalysisStep[] = [
    { id: "read", label: "契約書を受領しました", description: "解析を開始します", duration: 2000 },
    { id: "analyze", label: "条項をチェックしています", description: "リーガルチェック実行中", duration: 4000 },
    { id: "detect", label: "懸念事項を特定しています", description: "リスク評価中", duration: 5000 },
    ...
    return (
        <div className="bg-white rounded-2xl border border-primary/20 shadow-xl p-8 animate-in fade-in slide-in-from-bottom-4 duration-300">
            ...
            <div className="flex items-center justify-between mb-6">
                <h3 className="text-base font-medium text-primary">解析中です...</h3>
