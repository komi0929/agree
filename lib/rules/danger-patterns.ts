...
export const DANGER_PATTERNS: Record<string, DangerPattern[]> = {
    ...
    copyright: [
        ...
        {
            id: "copyright_003",
            pattern: /著作権.*譲渡(?!.*(?:27条|28条|翻案権|二次的著作物))/,
            risk: "medium",
            law: "copyright_art27_28",
            title: "著作権27条・28条の特掲なし",
            explanation: "著作権の譲渡条項がありますが、第27条（翻案権）・第28条（二次的著作物の利用権）の明記がありません。これらを譲渡する場合は「著作権法第27条および第28条に定める権利を含む」と明記する必要があります。",
            note: "発注者側としては明記を追加すべき。受注者側としてはこのままでも権利が残る可能性あり。",
        },
    ],
    ...
    liability_cap: [
        {
            id: "liability_cap_001",
            pattern: /損害賠償(?![\s\S]{0,100}(?:上限|を限度|報酬.*範囲|報酬額.*超えない))/,
            risk: "high",
            law: "civil_code_conformity",
            title: "損害賠償の上限規定なし",
            explanation: "損害賠償に関する条項がありますが、上限が設定されていません。報酬額を大幅に超える賠償を請求されるリスクがあります。「乙の賠償責任は、本契約に基づき支払われた報酬の総額を上限とする」と追記することを強く推奨します。",
        },
    ],
    ...
    acceptance_period: [
        {
            id: "acceptance_period_001",
            pattern: /検収.*(?:30日|１ヶ月|1ヶ月|一ヶ月).*(?:以内|まで)/,
            risk: "medium",
            law: "freelance_new_law_art4",
            title: "検収期間が長い（30日）",
            explanation: "検収期間が30日は長めです。検収が遅れると支払いも遅れます。「10〜14日以内」への短縮を交渉することをお勧めします。",
        },
        {
            id: "acceptance_period_002",
            pattern: /検収.*(?:60日|２ヶ月|2ヶ月|二ヶ月).*(?:以内|まで)/,
            risk: "high",
            law: "freelance_new_law_art4",
            title: "検収期間が非常に長い（60日）",
            explanation: "検収期間60日は非常に長く、支払いが大幅に遅れる原因になります。フリーランス新法の60日ルールにも影響します。「10〜14日以内」への大幅短縮を交渉してください。",
        },
    ],

    // ========================================
    // 買いたたきリスク（フリーランス新法第5条）
    // ========================================
    underpayment: [
        {
            id: "underpayment_001",
            pattern: /(?:相場|市場|通常).*(?:下回る|低い|安い)/,
            risk: "high",
            law: "freelance_new_law_art5",
            title: "買いたたきの可能性",
            explanation: "報酬が通常の相場を著しく下回る場合、フリーランス新法第5条の「買いたたき」に該当する可能性があります。",
        },
        {
            id: "underpayment_002",
            pattern: /(?:予算|原価).*(?:都合|理由).*(?:減額|値下げ)/,
            risk: "critical",
            law: "freelance_new_law_art5",
            title: "一方的な減額（買いたたき）",
            explanation: "予算の都合等を理由とした一方的な減額は、フリーランス新法第5条で禁止されている「買いたたき」に該当します。",
        },
    ],
