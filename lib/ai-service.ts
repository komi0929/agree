...
【revised_textに関する絶対禁止事項 - 必ず守ってください】
- 「具体的な修正案については専門家にご相談ください」という文言は絶対に出力しないでください
- 「専門家にご相談」「弁護士に相談」などの曖昧な表現は禁止です
- revised_text には必ず具体的な修正後の条文を記載してください
- プレースホルダーや定型句は絶対に使用しないでください
- 【例】✗「具体的な修正案については専門家にご相談ください。具体的な修正案については専門家にご相談ください。」
- 【例】○「甲は、乙に何らかの債務不履行がある場合に限り、書面による30日前の通知をもって本契約を解除することができる。」
- 【例】○「乙の損害賠償責任は、過去6ヶ月の報酬総額を上限とする。」
- 修正案は、元の条文を基に具体的・現実的に書き換えた文章にしてください`;
}
