        ...
        <div className="min-h-screen flex flex-col bg-white text-slate-600 font-sans selection:bg-slate-100 selection:text-slate-900">
            <main className="flex-1 max-w-2xl mx-auto w-full px-6 pt-24 pb-20">
                ...
                <div className="space-y-12">
                    ...
                    <section>
                        <h2 className="text-base font-medium text-slate-900 mb-4">第2条（サービスの性質と非保証）</h2>
                        <ul className="list-disc pl-5 space-y-3 text-sm text-slate-500 leading-relaxed font-light">
                            ...
                            <li><span className="text-slate-700 font-normal">本サービスが提供する解析結果、修正案、およびメッセージ案は、弁護士法上の「法律事務」を提供するものではなく、法的な助言や法的見解の正確性を保証するものではありません。</span></li>
                    ...
                    <section>
                        <h2 className="text-base font-medium text-slate-900 mb-4">第3条（損害賠償の制限）</h2>
                        <p className="text-sm text-slate-500 leading-relaxed font-light">
                    ...
                    <section>
                        <h2 className="text-base font-medium text-slate-900 mb-4">第4条（入力データの取扱いと守秘義務）</h2>
                        <ul className="list-disc pl-5 space-y-3 text-sm text-slate-500 leading-relaxed font-light">
                    ...
                    <section>
                        <h2 className="text-base font-medium text-slate-900 mb-4">第5条（サービスの変更・中断・終了）</h2>
                        <p className="text-sm text-slate-500 leading-relaxed font-light">
                    ...
                    <section>
                        <h2 className="text-base font-medium text-slate-900 mb-4">第6条（準拠法および裁判管轄）</h2>
