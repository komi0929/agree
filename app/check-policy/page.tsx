            ...
            <main className="flex-1 max-w-3xl mx-auto w-full px-6 pt-24 pb-20">
                ...
                <section className="mb-16">
                    <div className="bg-primary/5 rounded-2xl p-6 border border-primary/20">
                        <div className="flex gap-4 items-start">
                            <div className="flex-shrink-0 w-10 h-10 bg-white rounded-full flex items-center justify-center border border-primary/20">
                                <Scale className="w-4 h-4 text-primary" />
                            </div>
                            <div className="space-y-2">
                                <h2 className="text-base font-medium text-primary">私たちのチェック哲学</h2>
                ...
                <section className="mb-12">
                    <div className="flex gap-4 items-center mb-6">
                        ...
                        <div>
                            <h2 className="text-lg font-medium text-primary">28項目のチェックポイント</h2>
                            <p className="text-sm text-muted-foreground font-light">3つのカテゴリに分けてチェックしています</p>
                        </div>
                    </div>
                    ...
                    <div className="mb-10">
                        <div className="flex gap-3 items-center mb-4">
                            ...
                            <div>
                                <h3 className="text-base font-medium text-primary">修正すべき条項（11項目）</h3>
                                <p className="text-xs text-muted-foreground">契約書に存在すると危険な条項</p>
                            </div>
                        </div>
                        <div className="bg-white border border-primary/20 rounded-xl overflow-hidden">
                            <div className="divide-y divide-primary/10">
                                {checkpoints.mustFix.map((item) => (
                                    <div key={item.no} className="px-4 py-3 hover:bg-primary/5 transition-colors">
                    ...
                    <div className="mb-10">
                        <div className="flex gap-3 items-center mb-4">
                            ...
                            <div>
                                <h3 className="text-base font-medium text-primary">追加すべき条項（7項目）</h3>
                                <p className="text-xs text-muted-foreground">契約書に含めるべき保護条項</p>
                            </div>
                        </div>
                        <div className="bg-white border border-primary/20 rounded-xl overflow-hidden">
                            <div className="divide-y divide-primary/10">
                                {checkpoints.shouldAdd.map((item) => (
                                    <div
                                        key={item.no}
                                        className={`px-4 py-3 transition-colors ${item.highlight ? "bg-amber-50/30" : "hover:bg-primary/5"}`}
                                    >
                                        <div className="flex gap-3 items-start">
                    ...
                    <div className="mb-10">
                        <div className="flex gap-3 items-center mb-4">
                            ...
                            <div>
                                <h3 className="text-base font-medium text-primary">その他推奨条項（10項目）</h3>
                                <p className="text-xs text-muted-foreground">あると望ましい推奨条項</p>
                            </div>
                        </div>
                        <div className="bg-white border border-primary/20 rounded-xl overflow-hidden">
                            <div className="divide-y divide-primary/10">
                ...
                <section className="mb-16">
                    <div className="flex gap-4 items-center mb-6">
                        ...
                        <div>
                            <h2 className="text-lg font-medium text-primary">ハイブリッドチェック方式</h2>
                            <p className="text-sm text-muted-foreground font-light">確実性と文脈理解を両立</p>
                        </div>
                    </div>

                    <div className="space-y-4">
                        <div className="bg-white border border-primary/20 rounded-xl p-5">
                            <h4 className="text-sm font-medium text-primary mb-2">ルールベースチェック（確実性100%）</h4>
                        ...
                        <div className="bg-white border border-primary/20 rounded-xl p-5">
                            <h4 className="text-sm font-medium text-primary mb-2">AI解析（文脈理解）</h4>
                            <p className="text-xs text-muted-foreground leading-relaxed">
                        ...
                        <div className="bg-white border border-primary/20 rounded-xl p-5">
                            <h4 className="text-sm font-medium text-primary mb-2">欠落チェック（沈黙は危険）</h4>
                            <p className="text-xs text-muted-foreground leading-relaxed">
                ...
                <section className="mb-16">
                    <div className="bg-primary/5 rounded-2xl p-6 border border-primary/20">
                        <h3 className="text-sm font-medium text-primary mb-3">ご注意ください</h3>
                ...
                <div className="text-center">
                    <Link
                        href="/"
                        className="inline-flex items-center justify-center rounded-full px-8 py-4 bg-white border border-primary/20 text-primary hover:bg-primary/5 hover:border-primary/40 shadow-sm transition-all text-sm font-normal"
                    >
                        契約書をチェックする
                    </Link>
                </div>
